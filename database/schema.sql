...
CREATE TABLE categories (
  ...
  image        VARCHAR(255) DEFAULT NULL COMMENT 'تصویر پس‌زمینه کارت دسته در صفحه اصلی',
  icon         VARCHAR(255) DEFAULT NULL COMMENT 'آیکون کوچک برای نمایش در مگا منو',
...
CREATE TABLE posts (
  ...
  meta_title       VARCHAR(191) DEFAULT NULL COMMENT 'عنوان سئو (تگ title)',
  meta_description VARCHAR(300) DEFAULT NULL COMMENT 'توضیح متا برای گوگل',
  focus_keyword    VARCHAR(120) DEFAULT NULL COMMENT 'کلمه کلیدی اصلی مطلب',
