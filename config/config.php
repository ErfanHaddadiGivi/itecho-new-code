...
$config = [
    ...
    // مسیر پوشهٔ ربات اپل‌آیدی (appleid-bot) روی همین هاست.
    // اگر تنظیم شود، بخش «سفارش اپل‌آیدی» سایت به دیتابیس مشترکِ ربات وصل
    // می‌شود (سفارش‌ها در همان‌جا ثبت و از داخل بله مدیریت می‌شوند).
    // مثال: '/home/USER/appleid-bot'
    'appleid_bot_path' => '',
];
