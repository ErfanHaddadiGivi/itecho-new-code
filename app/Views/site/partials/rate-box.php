...
<aside class="rate-box<?= !empty($seed['stale']) ? ' is-stale' : '' ?>"
    ...
    <div class="rate-box__head" data-rate-toggle role="button" tabindex="0"
         aria-expanded="true" aria-controls="rate-box-body" title="کوچک/بزرگ کردن">
        ...
        <span class="rate-box__chevron" aria-hidden="true">▾</span>
    </div>

    <div class="rate-box__body" id="rate-box-body">
