...
<div class="admin-shell">
    ...
    <aside class="admin-sidebar" id="admin-sidebar">
        ...
        <nav class="admin-nav">
            ...
            <span class="admin-nav__label">محتوا</span>
            <a class="admin-nav__link<?= $isActive('posts') ?>" href="<?= e(url('admin/posts')) ?>">مجله آیتکو</a>
            <a class="admin-nav__link<?= $isActive('pages') ?>" href="<?= e(url('admin/pages')) ?>">متن صفحات</a>
            ...
            <a class="admin-nav__link<?= $isActive('ad-banner') ?>" href="<?= e(url('admin/ad-banner')) ?>">بنر تبلیغاتی</a>
            <a class="admin-nav__link<?= $isActive('page-videos') ?>" href="<?= e(url('admin/page-videos')) ?>">ویدیوی صفحات</a>

            <span class="admin-nav__label">پیکربندی</span>
            <a class="admin-nav__link<?= $isActive('sync-logs') ?>" href="<?= e(url('admin/sync-logs')) ?>">همگام‌سازی محصولات</a>
